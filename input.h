...
void collectSignatures(Contig &TheContig, std::vector<Signature> *ContigTypeSignatures, Arguments & Args, std::vector<Stats> AllStats, std::vector<int> AllTechs,const char * DataSource=0);
